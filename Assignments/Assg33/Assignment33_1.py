...
def SendMail(LogFileName, StartTime, EndTime, DirectoryName, TotalFiles, DuplicateFound, DuplicateDeleted):
    ...
    try:
        ...
        server.login("demon10feb@gmail.com", "pvsb vsiz jrox rpfy")
...
def main():
    ...
    if(len(sys.argv) == 4):
        if(sys.argv[1] == "--h" or sys.argv[1] == "--H" ):
            ...
            schedule.every(int(sys.argv[2])).minutes.do(FindDuplicate,sys.argv[1])
